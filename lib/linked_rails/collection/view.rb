...
module LinkedRails
  class Collection
    class View
      ...
      delegate :association_base, :association_class, :default_page_size, :parent, :policy, :user_context,
               to: :collection
      ...
      class << self
        ...
        def new(opts = {})
          ...
          case type
          when :paginated
            LinkedRails.paginated_view_class.new(opts)
          when :infinite
            LinkedRails.infinite_view_class.new(opts)
          else
